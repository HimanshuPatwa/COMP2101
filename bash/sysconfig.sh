...
cat << EOF
	Usage: `basename $0` [-h] -- program to show system information.
	-h |--help	Show this help message
  	--host		Display host name
  	--domain	Show domain name
  	--ipconfig	Show only IP information
  	--os 		Show only OS information
  	--cpu 		Show only CPU information
  	--memory 	Show only system memory information
  	--disk 		Show only system disk information
  	--printer 	Show only printer information
EOF
}
